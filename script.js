...
// initializing object variable to store details
...
function getUserDetails(){
    ...
    //stores the email in the userDetailsDatabase
    ...
    function validateUserName(userName){
        // if the username is null, the funtion ends
        if (userName == null){
            return
        }
    ...
    function validateUserEmail(email){
        ...
        // if the email is null, the funtion ends
        if (email == null){
            return
        }
    ...
    function validateUserPhoneNumber(userName){
        // if the phone number is null, the funtion ends
        if (phoneNumber == null){
            return
        }
    ...
    function validatePassword(password){
        // if the password is empty, the function ends
        if (password == null){
            return
        }
    ...
    function validateConfirmPassword(confirmPassword){
        // if confirmPassword is empty the function ends
        if (confirmPassword == null){
            return
